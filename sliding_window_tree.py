...
def process_windows(ref_fasta_filename, sam_filename, out_dir, mapping_cutoff, read_qual_cutoff, max_prop_N,
    ...
    LOGGER.debug("Start Full MSA-Fasta from SAM")
    ...
    LOGGER.debug("Done Full MSA-Fasta from SAM")
    ...
    for ref in ref_to_len:
        ...
        for start_nucpos in range(1, last_window_start_nucpos):  # start_nucpos is 1-based nucleotide position
            ...
            LOGGER.debug("Start Create Sliced MSA-Fasta " + str(start_nucpos) + "-" + str(end_nucpos))
            ...
            LOGGER.debug("Done Create Sliced MSA-Fasta " + str(start_nucpos) + "-" + str(end_nucpos) +
                         ".  Wrote " + str(total_slice_seq) + " to file")

            if total_slice_seq < window_depth_thresh:
                LOGGER.warn("Window " + str(start_nucpos) + "-" + str(end_nucpos) + " does not satisfy window depth constraints")
            else:
                # Feed window fasta into fasttree to make a tree
                LOGGER.debug("Window " + str(start_nucpos) + "-" + str(end_nucpos) +" satisfies window depth constraints")
                LOGGER.debug("Start Fasttree for window " + str(start_nucpos) + "-" + str(end_nucpos))
                ...
                LOGGER.debug("Done Fasttree for window " + str(start_nucpos) + "-" + str(end_nucpos))

                LOGGER.debug("Start HyPhy for window " + str(start_nucpos) + "-" + str(end_nucpos))
                ...
                LOGGER.debug("Done HyPhy for window " + str(start_nucpos) + "-" + str(end_nucpos))

    LOGGER.debug("Start Ave Dn/DS for all windows")
    ...
    LOGGER.debug("Done Ave Dn/DS for all windows")
