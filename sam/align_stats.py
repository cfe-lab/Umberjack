class AlignStats:
    def __init__(self):
        ...
        self.total_match_conflict_hi_qual = 0  # bases in overlapping position of mates, bases not shared by both mates.  1 mate high qual.
        ...
        self.total_match_conflict_equal_lo_qual = 0  # bases in overlapping position of mates, bases not shared by both mates.  both mates high qual
    ...
    def merge_stats(self, other_stats):
        ...
        self.total_match_conflict_hi_qual += other_stats.total_match_conflict_hi_qual  # bases in overlapping position of mates, bases not shared by both mates.  1 mate high qual.
    ...
    def dump_stats(self):
        output = ("total_insert_1mate_hi_qual={}\n".format(self.total_insert_1mate_hi_qual) +
                  ...
                  "total_match_conflict_equal_lo_qual={}\n".format(self.total_match_conflict_equal_lo_qual))
        return output