...
def get_seq_dnds_info(output_prefix, ref_codon_len):
    """
    ...
    :rtype: [SiteDnDsInfo]
    :param str output_prefix:  output prefix of sitewise dn/ds tab-separated files generated by HyPhy
    ...
    for dnds_tsv_filename in glob.glob(output_prefix + "*.dnds.tsv"):
...
def tabulate_dnds(output_prefix, ref, ref_nuc_len, output_csv_filename, comments=""):
    """
    ...
    :param str output_prefix:  output prefix of dN/dS tab separated files generated by HyPhy
