...
SAM_FILENAME = os.path.dirname(__file__) + os.sep + "simulations/data/indelible/cov1x/sample_genomes.100.1x.errfree.consensus.sam"
...
REFERENCE_FASTA =  os.path.realpath(__file__) + os.sep + "simulations/data/indelible/sample_genomes.100.consensus.fasta"
REF = "consensus"
REF_LEN = 9000
OUT_DIR =   os.path.dirname(__file__) + os.sep +"simulations/out/consensus/mut100_1x_errfree_window400"
