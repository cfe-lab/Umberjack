...
intervals = [Interval(scaling_factor=1.0, num_codons=100),
             Interval(scaling_factor=2.0, num_codons=100),
             Interval(scaling_factor=5.0, num_codons=100),
             Interval(scaling_factor=10.0, num_codons=200),
             Interval(scaling_factor=20.0, num_codons=200),
             Interval(scaling_factor=50.0, num_codons=300),
             Interval(scaling_factor=100.0, num_codons=1000),
             Interval(scaling_factor=50.0, num_codons=300),
             Interval(scaling_factor=20.0, num_codons=200),
             Interval(scaling_factor=10.0, num_codons=200),
...
ratefile = open(root + 'sample_genomes.rates.higher.csv', 'w')  # keep track of each codon site omega
...
# output            
outfile = open(root+'sample_genomes.higher.fasta', 'w')
