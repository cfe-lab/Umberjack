...
KAPPA = 8.0  # Number of discrete omega categories


treefile = sys.argv[1]
global_scaling_factor = float(sys.argv[2])  # factor to stretch entire tree by (mutation rate)
n_sites = int(sys.argv[3])  # Number of codon sites in the genome
output_dir = sys.argv[4]  # Output directory
output_filename_prefix = sys.argv[5] # Output will be written to <outputdir>/<output_filename_prefix>.nex
