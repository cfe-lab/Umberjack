...
class TestSlidingWindowTree(unittest.TestCase):
    ...
    def test_indelible_tree_len(self):
        ...
        actual_tree_len = TestSlidingWindowTree.get_tree_len(indelible_tree_handle)
    ...
    #     leaf_fasta = "/home/thuy/gitrepo/SlidingWindow/test/simulations/data/small/small_population.50.0_TRUE.fasta"
    #     ancestor_fasta = "/home/thuy/gitrepo/SlidingWindow/test/simulations/data/small/small_population.50.0_ANCESTRAL.fasta"
    #     expected_sites_dnds_csv = "/home/thuy/gitrepo/SlidingWindow/test/simulations/data/small/small_population.50.0_RATES.csv"
    #
    #     indelible_tree_txt = "/home/thuy/gitrepo/SlidingWindow/test/simulations/data/small/trees.txt"
    #     indelible_tree_str = indelibler.get_tree_string(indelible_tree_txt)
    #     indelible_tree_handle = StringIO(indelible_tree_str)
